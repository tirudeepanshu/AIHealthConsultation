      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <p className="text-xs text-yellow-800">
            <strong>Important:</strong> By creating an account, you acknowledge that HealthAI 
            provides AI-generated health guidance for informational purposes only and is not 
